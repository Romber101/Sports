...
<div class="Message">
    <form action="Project_Server.php" method="post">
        <table>
            <tr>
                <th>id</th>
                <th>calendar</th>
            ...
            try {
                ...
                if ($set_name == "root") {
                    $sql = "select * from information where calendar='$set_calendar'";
                    $set = $conn->query($sql);
    ...
    <a href="Project.php?name=root" style="position: absolute;left: 300px;width: 100px;">返回</a>
</div>
</body>
</html>